...
//      02111-1307, USA.
//
//      $Id: player.cpp 7879 2007-01-09 08:07:46Z jsalmon3 $
...
int EnableAI = 1; // StratagusAI MOD.  
...
void SavePlayers(CFile *file)
{
	...
	file->printf("\n--------------------------------------------\n");
	file->printf("--- MODULE: players $Id: player.cpp 7879 2007-01-09 08:07:46Z jsalmon3 $\n\n");
