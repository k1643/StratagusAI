...
//      02111-1307, USA.
//
//      $Id: unit.cpp 7868 2007-01-07 03:00:42Z jsalmon3 $
...
void LetUnitDie(CUnit *unit)
{
    ...
    // StratagusAI MOD =============================================
    socketInterface->addEvent(SocketInterface::DIED,
                UnitNumber(unit), -1);
    // =============================================================
...
void SaveUnits(CFile *file)
{
	...
	file->printf("\n--- -----------------------------------------\n");
	file->printf("--- MODULE: units $Id: unit.cpp 7868 2007-01-07 03:00:42Z jsalmon3 $\n\n");
